...
import { FaEnvelope, FaPhoneAlt, FaMapMarkerAlt, FaLinkedin, FaGithub, FaTwitter, FaTelegram, FaInstagram } from "react-icons/fa";
    ...
    >
      <div className="glass rounded-xl p-6 shadow-soft border border-transparent panel-bg">
        <div className="flex flex-col items-center">
          ...
          <h2 className="mt-4 text-xl font-semibold">Liben Adugna</h2>
        ...
        <div className="mt-6 flex justify-left gap-6 text-gray-300">
          <a aria-label="LinkedIn" href="#"><FaLinkedin size={25} /></a>
          <a aria-label="GitHub" href="#"><FaGithub size={25} /></a>
          <a aria-label="Twitter" href="#"><FaTwitter size={25} /></a>
          <a aria-label="Telegram" href="#"><FaTelegram size={25} /></a>
          <a aria-label="Instagram" href="#"><FaInstagram size={25}/></a>
